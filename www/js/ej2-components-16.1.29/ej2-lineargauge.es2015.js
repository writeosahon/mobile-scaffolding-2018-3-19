...
class GaugeTooltip {
     ...
     */
    renderTooltip(pointerElement) {
        this.pointerElement = pointerElement;
        let clientRect = this.gauge.element.getBoundingClientRect();
        let current = getPointer(pointerElement, this.gauge);
        this.currentAxis = current.axis;
        this.axisIndex = current.axisIndex;
        this.currentPointer = current.pointer;
        let ele = this.appendTargetElement();
    ...
    appendTargetElement() {
        ...
        let element = getElement(this.element.id + '_EJTooltip_');
        let elementSpace = 2;
        if (element) {
    ...
    onBeforeRender(args) {
        let pointerValue = convertPixelToValue(this.element, this.pointerElement, this.gauge.orientation, this.currentAxis, 'tooltip', null);
